...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Sprawdź czy błąd zawiera znany komunikat o nieprawidłowych danych
      const errorMessage = err instanceof Error ? err.message : t('errors.login_failed');
      
      if (errorMessage.includes('invalid') || errorMessage.includes('nieprawidłowy') || 
          errorMessage.includes('email') || errorMessage.includes('hasło')) {
